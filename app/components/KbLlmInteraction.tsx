    ...
    <div className="space-y-4">
      <div>
        ...
        <textarea
          ...
          placeholder="Ask AI to help improve this article. For example: 'Make it more concise' or 'Add more technical details about X'. Press Cmd+Enter (Mac) or Ctrl+Enter (Windows) to submit."
          rows={3}
